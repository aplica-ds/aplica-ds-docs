...
- Script de geração da escala: [dimension-scale.mjs](https://github.com/aplica-ds/aplica-tokens-theme-engine/blob/main/dynamic-themes/scripts/dimension-scale.mjs)
- Spec técnica de saída de unidades: [05-output-units.md](https://github.com/aplica-ds/aplica-tokens-theme-engine/blob/main/docs/context/dimension/05-output-units.md)
- Visão geral da Dimension: [00-overview.md](https://github.com/aplica-ds/aplica-tokens-theme-engine/blob/main/docs/context/dimension/00-overview.md)
- Sistema espacial detalhado: [01-spatial-system.md](https://github.com/aplica-ds/aplica-tokens-theme-engine/blob/main/docs/context/dimension/01-spatial-system.md)
