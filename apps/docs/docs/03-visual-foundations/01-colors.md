...
- Script de decomposição: [color-decomposer.mjs](https://github.com/aplica-ds/aplica-tokens-theme-engine/blob/main/dynamic-themes/scripts/color-decomposer.mjs)
- Spec técnica: [COLOR-DECOMPOSITION-SPEC.md](https://github.com/aplica-ds/aplica-tokens-theme-engine/blob/main/docs/context/dynamic-themes-reference/COLOR-DECOMPOSITION-SPEC.md)
- Exemplo de config: [aplica-joy.config.mjs](https://github.com/aplica-ds/aplica-tokens-theme-engine/blob/main/config/aplica-joy.config.mjs)
