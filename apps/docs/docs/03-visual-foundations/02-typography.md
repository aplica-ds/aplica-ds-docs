...
- Script de geração: [typography-generator.mjs](https://github.com/aplica-ds/aplica-tokens-theme-engine/blob/main/dynamic-themes/scripts/typography-generator.mjs)
- Escala derivada por Dimension: [typography-scale-from-dimension.mjs](https://github.com/aplica-ds/aplica-tokens-theme-engine/blob/main/dynamic-themes/scripts/typography-scale-from-dimension.mjs)
- Spec técnica: [TYPOGRAPHY-SPEC.md](https://github.com/aplica-ds/aplica-tokens-theme-engine/blob/main/docs/context/dynamic-themes-reference/TYPOGRAPHY-SPEC.md)
- Detalhe da escala: [02-typography-scale.md](https://github.com/aplica-ds/aplica-tokens-theme-engine/blob/main/docs/context/dimension/02-typography-scale.md)
- Line heights: [03-line-height-scale.md](https://github.com/aplica-ds/aplica-tokens-theme-engine/blob/main/docs/context/dimension/03-line-height-scale.md)
