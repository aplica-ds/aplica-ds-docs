...
- Implementação no engine: [sync-architecture.mjs](https://github.com/aplica-ds/aplica-tokens-theme-engine/blob/main/dynamic-themes/scripts/sync-architecture.mjs)
